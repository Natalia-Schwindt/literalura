...
* **💻 Interfaz Web:** Migrar este motor de búsqueda a una aplicación web dinámica utilizando **Spring MVC y Thymeleaf** para una experiencia de usuario enriquecida y visual.
